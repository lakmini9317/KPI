...
<select name="division">
        ...
        <option value="Uva Provincial Office">Badulla Office</option>
        ...
        <option value="Gall Provincial Office">Galle Office</option>
...
if($stmt = $connection->query("SELECT desig,noc,j_total,f_total,m_total,division FROM suboffice_2022 WHERE division='$subdivi' ")){
