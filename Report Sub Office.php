<?php  
 ...
 $query = "SELECT division, count(*) as number FROM suboffice_2022 GROUP BY division";  
 $result = mysqli_query($connect, $query); 
 
 
 $query2 = "SELECT j_total, count(*) as number FROM suboffice_2022 GROUP BY j_total";  
 $result2 = mysqli_query($connect, $query2);  

 $query3 = "SELECT f_total, count(*) as number FROM suboffice_2022 GROUP BY f_total";  
 $result3 = mysqli_query($connect, $query3);  


 $query4 = "SELECT m_total, count(*) as number FROM suboffice_2022 GROUP BY m_total";  
